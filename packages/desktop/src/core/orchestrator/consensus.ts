// ── consensus.ts — Council consensus signal bus ───────────────────────────────
//
// Emits a 'council:consensus' event when the experiment runner selects a winner
// from competing candidate plans. The IPC layer forwards this to the renderer,
// which can display a triangle merge animation + confirmation tone.
//
// Usage:
...
// Emitted alongside council:consensus. The renderer can use this to show
// the winning approach name and score (e.g. in the triangle merge animation).
